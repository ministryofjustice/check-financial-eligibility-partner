...
module Calculators
  RSpec.describe MonthlyIncomeConverter do
    subject(:converter) { described_class.call(frequency, payments) }
    ...
    context "Unrecognized frequency" do
      ...
      it "raises an error" do
        expect { converter }.to raise_error("Unrecognized frequency")
      end
    end
  end
end
