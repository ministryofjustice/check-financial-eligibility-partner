# Commenting this file out for the fork of CFE
# We have an alternative solution using cucumber covered in this PR
# https://github.com/ministryofjustice/check-financial-eligibility-partner/pull/2
# Which will test features we add to the fork
# These tests require some extra authentication which may take some time and effort to obtain
# and set up. Removing these tests does not impact coverage.
#
#
